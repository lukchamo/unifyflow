...
export interface WhatsAppIconProps {
  size?: number;
  className?: string;
  /** Defaults to the WhatsApp brand green. */
  color?: string;
}

/**
 * WhatsAppIcon — inline glyph. Decorative by default: the buttons that use it
 * always carry their own text label.
 */
